									...
									<div
										...
										<div className="tab-content" id="notificationItemsTabContent">
											<div
												...
												id="all-noti-tab"
												role="tabpanel">
												<div data-simplebar style="max-height: 300px" className="pe-2">
									...
									<div className="layout-rightside">
										<div className="card h-100 rounded-0">
											<div className="card-body p-0">
												...
												<div data-simplebar style="max-height: 410px" className="p-3 pt-0">
							...
							<div id="layout-position">
								...
								<div className="btn-group radio" role="group">
									<input
										...
										value="fixed"
									/>
									<label className="btn btn-light w-sm" for="layout-position-fixed">
										Fixed
									</label>
									...
									<input
										...
										value="scrollable"
									/>
									<label className="btn btn-light w-sm ms-0" for="layout-position-scrollable">
										Scrollable
									</label>
								</div>
							</div>
								...
								<div className="d-flex gap-2 flex-wrap img-switch">
									<div className="form-check sidebar-setting card-radio">
										<input
											...
											value="none"
										/>
										<label className="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-none">
									...
									<div className="form-check sidebar-setting card-radio">
										<input
											...
											value="img-1"
										/>
										<label className="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
											<img
									...
									<div className="form-check sidebar-setting card-radio">
										<input
											...
											value="img-2"
										/>
										<label className="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
											<img
									...
									<div className="form-check sidebar-setting card-radio">
										<input
											...
											value="img-3"
										/>
										<label className="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
											<img
									...
									<div className="form-check sidebar-setting card-radio">
										<input
											...
											value="img-4"
										/>
										<label className="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
											<img

!(function () {
	...
	function E() {
		...
		!a ||
			...
			Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(
				function (e) {
			...
			(a = (a = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(
				a.lastIndexOf("/") + 1
			)) &&
						...
						e.parentElement.closest(".collapse.menu-dropdown") &&
							...
							e.parentElement.parentElement.parentElement.parentElement.closest(
								...
								(e.parentElement.parentElement.parentElement.parentElement
									.closest(".collapse")
									.classList.add("show"),
								e.parentElement.parentElement.parentElement.parentElement.closest(".collapse")
									.previousElementSibling &&
									e.parentElement.parentElement.parentElement.parentElement
										.closest(".collapse")
										.previousElementSibling.classList.add("active")))))),
			(document.getElementById("two-column-menu").innerHTML = n.outerHTML),
			Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(
				function (a) {
					var n = (n =
						"/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(
						n.lastIndexOf("/") + 1
					);
					a.addEventListener("click", function (e) {
						var t;
						(n != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) &&
			...
			"horizontal" !== document.documentElement.getAttribute("data-layout") &&
				((e = new SimpleBar(document.getElementById("navbar-nav"))) && e.getContentElement(),
	...
	function v() {
		...
		e < 1025 && 767 < e
			...
			: e <= 767 &&
			  ...
			  "twocolumn" == sessionStorage.getItem("data-layout") &&
					(document.documentElement.setAttribute("data-layout", "vertical"), z("vertical"), p()),
	...
	function S(e) {
		if (e.target && e.target.matches("a.nav-link span"))
			...
			} else if (1 == f(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth)
		...
		if (e.target && e.target.matches("a.nav-link"))
			...
			} else if (1 == f(e.target.nextElementSibling) && 1848 <= window.innerWidth)
	...
	function I() {
		document.addEventListener("DOMContentLoaded", function () {
			...
			document.getElementById("topnav-hamburger-icon") &&
				document.getElementById("topnav-hamburger-icon").addEventListener("click", w);
		var e = sessionStorage.getItem("defaultAttribute"),
			t = JSON.parse(e),
			e = document.documentElement.clientWidth;
		"twocolumn" == t["data-layout"] &&
			e < 767 &&
			Array.from(document.getElementById("two-column-menu").querySelectorAll("li")).forEach(
				function (e) {
	...
	function A() {
		...
		(a = a.substring(a.lastIndexOf("/") + 1)) &&
			...
			(e = document.getElementById("navbar-nav").querySelector('[href="' + a + '"]'))
						...
						t.parentElement.closest(".collapse.menu-dropdown")
							? (t.classList.add("show"),
							  ...
							  t.parentElement.parentElement.parentElement.parentElement.closest(
									...
									((a = t.parentElement.parentElement.parentElement.parentElement
										.closest(".collapse.menu-dropdown")
										.getAttribute("id")),
									...
									document.getElementById("two-column-menu").querySelector('[href="#' + a + '"]') &&
										document
											...
											.querySelector('[href="#' + a + '"]')
											.classList.add("active")),
							  t.parentElement.closest(".collapse.menu-dropdown").getAttribute("id"))
							: (e
									.closest(".collapse.menu-dropdown")
									.parentElement.classList.add("twocolumn-item-show"),
							  t.getAttribute("id"))),
	...
	function C(t, a) {
		Array.from(document.querySelectorAll("input[name=" + t + "]")).forEach(function (e) {
				...
				e.addEventListener("change", function () {
					document.documentElement.setAttribute(t, e.value),
						...
						"data-layout-width" == t && "boxed" == e.value
							? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"),
							  sessionStorage.setItem("data-sidebar-size", "sm-hover"),
							  (document.getElementById("sidebar-size-small-hover").checked = !0))
							: "data-layout-width" == t &&
							  "fluid" == e.value &&
							  (document.documentElement.setAttribute("data-sidebar-size", "lg"),
							  sessionStorage.setItem("data-sidebar-size", "lg"),
							  (document.getElementById("sidebar-size-default").checked = !0)),
						"data-layout" == t &&
							("vertical" == e.value
			...
			Array.from(document.querySelectorAll("#collapseBgGradient .form-check input")).forEach(
				function (e) {
	...
	sessionStorage.getItem("defaultAttribute")
		...
		: ((i = document.documentElement.attributes),
		  ...
		  Array.from(i).forEach(function (e) {
				...
				e &&
					...
					((t = e.nodeName), (a[t] = e.nodeValue), sessionStorage.setItem(t, e.nodeValue));
		  }),
		...
		(i = document.querySelectorAll(".light-dark-mode")) &&
			...
			i[0].addEventListener("click", function (e) {
				l.hasAttribute("data-layout-mode") && "dark" == l.getAttribute("data-layout-mode")
			...
			"flatpickr" == e.getAttribute("data-provider")
				? ((n = {}),
				  ...
				  t["data-multiple-date"] &&
						((n.mode = "multiple"), (n.dateFormat = t["data-date-format"].value.toString())),
				  t["data-range-date"] &&
						((n.mode = "range"), (n.dateFormat = t["data-date-format"].value.toString())),
				  t["data-inline-date"] &&
						((n.inline = !0),
						(n.defaultDate = t["data-deafult-date"].value.toString()),
						(n.dateFormat = t["data-date-format"].value.toString())),
				  t["data-disable-date"] &&
						((a = []).push(t["data-disable-date"].value), (n.disable = a.toString().split(","))),
				  flatpickr(e, n))
				: "timepickr" == e.getAttribute("data-provider") &&
				  ...
				  n["data-time-hrs"] &&
						((a.enableTime = !0), (a.noCalendar = !0), (a.dateFormat = "H:i"), (a.time_24hr = !0)),
				  n["data-min-time"] &&
						((a.enableTime = !0),
						(a.noCalendar = !0),
						(a.dateFormat = "H:i"),
		...
		Array.from(document.querySelectorAll('.dropdown-menu a[data-bs-toggle="tab"]')).forEach(
			function (e) {
				e.addEventListener("click", function (e) {

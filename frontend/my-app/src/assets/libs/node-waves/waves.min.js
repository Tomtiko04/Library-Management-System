!(function (t, e) {
	...
	function i(t) {
		...
		return (
			...
			(o = e(i)),
			{ top: a.top + o.pageYOffset - n.clientTop, left: a.left + o.pageXOffset - n.clientLeft }
		);
	}
	function r(t) {
		var e = "";
		...
		v = {
			...
			show: function (t, e, n) {
				...
				"touches" in t && t.touches.length
					? ((s = t.touches[0].pageY - a.top), (u = t.touches[0].pageX - a.left))
			...
			hide: function (t, e) {
				for (
					var n = (e = e || this).getElementsByClassName("waves-rippling"), o = 0, a = n.length;
					o < a;
					o++
				)
					s(t, e, n[o]);
				m &&
					(e.removeEventListener("touchend", v.hide), e.removeEventListener("touchcancel", v.hide)),
	...
	return (
		...
		(l.attach = function (t, e) {
			...
			for (var n, o, i = 0, r = t.length; i < r; i++)
				(o = (n = t[i]).tagName.toLowerCase()),
					-1 !== ["input", "img"].indexOf(o) && (p[o](n), (n = n.parentElement)),
		...
		(l.calm = function (t) {
			for (var e = { type: "mouseup", button: 1 }, n = 0, o = (t = a(t)).length; n < o; n++)
				v.hide(e, t[n]);
		}),
